...
filename = '02'
Flow = readmatrix(['Control_Sun_' filename '_PCAv.csv']);
markers = readmatrix(['Control_Sun_' filename '_timestamps.csv']);
ABP = readmatrix(['Control_Sun_' filename '_ABP.csv']);
